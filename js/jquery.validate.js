...
$.extend( $.validator, {
	...
	messages: {
		...
		creditcard: "Por favor ingresa un número de tarjeta de crédito válido.",
		equalTo: "Por favor ingresa de nuevo el mismo valor.",
		maxlength: $.validator.format( "Ha excedido el máximo de caracteres permitidos." ),
